...
let GamePlayHumansAndComputers = (function () {
	...
	Players.savePlayerPreferencesBtn.addEventListener('click', () => {
		Players.playerXTypeInput.value === 'Computer' ? (playerXisComputer = true) : (playerXisComputer = false);
		Players.playerOTypeInput.value === 'Computer' ? (playerOisComputer = true) : (playerOisComputer = false);
